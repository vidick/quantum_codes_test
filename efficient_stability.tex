...
\paragraph{Acknowledgments.} TV is supported by a research grant from the Center for New Scientists at the Weizmann Institute of Science, a Simons Investigator award, AFOSR Grant No. FA9550-22-1-0391, and ERC Consolidator Grant VerNisQDevS (101086733).
...
\tnote{added this here to clarify:}
...
\begin{remark}
As discussed in the introduction, in the literature on stability it is more common to use a $L^\infty$ analogue of our Definition~\ref{def:eff-stab}, where the notion of almost-homomorphism and closeness are both measured by taking a supremum over relations and generators respectively, as opposed to averaging according to distributions $\mu_R,\mu_S$. 
